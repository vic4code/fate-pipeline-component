...
sudo kubectl exec client-0 -n fate-9999 -- sh -c 'rm -rf /data/projects/fate/persistence/*'
sudo kubectl cp persistence fate-9999/client-0:/data/projects/fate
sudo kubectl exec client-0 -n fate-10000 -- sh -c 'rm -rf /data/projects/fate/persistence/*'
